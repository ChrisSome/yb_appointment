...
class AssignController extends ValidateController
{
    ...
    public function actionSignup()
    {
        ...
        return $this->render('_form', ['model' => $model, 'AuthItem' => $AuthItem]);
    }
    ...
    public function actionUpdate($id)
    {
        ...
        $direct_url = $canRunIndex ? 'index' : '/report/dashboard/index';
        ...
        return $this->render('_form', ['model' => $model, 'AuthItem' => $AuthItem, 'isRoot' => $isRoot]);
    }
