...
namespace common\extend\Export;

use Yii;
use common\extend\Export\DataType\DataTypeInterface;
                ...
                foreach ($data as $key => $row) {
                    ...
                    foreach ($fields as $field => $value) {
                        ...
                        if (empty($pValue)) {
                            ...
                            $rows[$field] = $this->convertCharset($pValue, 'UTF-8', 'GBK');
                        }
                    }
                    fputcsv($fp, $rows);
                    $num++;
